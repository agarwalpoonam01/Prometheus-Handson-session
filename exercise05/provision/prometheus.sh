...
install -m 0644 /vagrant/exercise05/configs/prometheus/prometheus.service /etc/systemd/system/
install -m 0644 -o prometheus -g prometheus -D /vagrant/exercise05/configs/prometheus/prometheus{,_file_sd}.yml /etc/prometheus/

systemctl daemon-reload
systemctl enable prometheus
systemctl start prometheus

/vagrant/exercise05/provision/custom-sd.sh
