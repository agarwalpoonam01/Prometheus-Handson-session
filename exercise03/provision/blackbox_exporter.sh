...
install -m 0644 -D /vagrant/exercise03/configs/blackbox_exporter/blackbox.yml /etc/blackbox_exporter/blackbox.yml
install -m 0644 /vagrant/exercise03/configs/blackbox_exporter/blackbox-exporter.service /etc/systemd/system/
