...
install -m 0644 -D /vagrant/exercise03/configs/grok_exporter/config.yml /etc/grok_exporter/
install -m 0644 /vagrant/exercise03/configs/grok_exporter/grok-exporter.service /etc/systemd/system/
