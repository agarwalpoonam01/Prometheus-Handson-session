...
install -m 0644 -D /vagrant/exercise03/configs/mtail_exporter/line_count.mtail /etc/mtail_exporter/
install -m 0644 /vagrant/exercise03/configs/mtail_exporter/mtail-exporter.service /etc/systemd/system/
