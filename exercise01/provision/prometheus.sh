...
install -m 0644 /vagrant/exercise01/configs/prometheus/prometheus.service /etc/systemd/system/
install -m 0644 -D /vagrant/exercise01/configs/prometheus/prometheus.yml /etc/prometheus/prometheus.yml
install -m 0644 -D /vagrant/exercise01/configs/prometheus/first_rules.yml /etc/prometheus/first_rules.yml
