...
install -m 0644 -D /vagrant/exercise02/configs/blackbox_exporter/blackbox.yml /etc/prometheus/blackbox.yml
install -m 0644 /vagrant/exercise02/configs/blackbox_exporter/blackbox-exporter.service /etc/systemd/system/
