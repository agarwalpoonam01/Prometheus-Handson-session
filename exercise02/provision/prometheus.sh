...
install -m 0644 /vagrant/exercise02/configs/prometheus/prometheus.service /etc/systemd/system/
install -m 0644 -D /vagrant/exercise02/configs/prometheus/prometheus.yml /etc/prometheus/prometheus.yml
