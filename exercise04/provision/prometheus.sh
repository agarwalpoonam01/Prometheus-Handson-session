...
install -m 0644 -D -t /usr/share/prometheus/consoles /vagrant/exercise04/configs/prometheus/grafana.html
...
install -m 0644 /vagrant/exercise04/configs/prometheus/prometheus.service /etc/systemd/system/
install -m 0644 -D /vagrant/exercise04/configs/prometheus/prometheus.yml /etc/prometheus/prometheus.yml
